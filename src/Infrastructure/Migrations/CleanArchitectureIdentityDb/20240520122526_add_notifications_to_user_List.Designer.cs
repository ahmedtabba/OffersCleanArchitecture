...
namespace DataCollector.CleanArchitecture.Infrastructure.Migrations.CleanArchitectureIdentityDb
{
    ...
    [Migration("20240520122526_add_notifications_to_user_List")]
    partial class add_notifications_to_user_List
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Infrastructure.Identity.ApplicationGroupRole", b =>
                {
                    ...
                    b.ToTable("ApplicationGroupRoles", (string)null);
                });
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("NotificationGroupIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UserNotificationIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Infrastructure.Identity.ApplicationUserGroup", b =>
                {
                    ...
                    b.ToTable("ApplicationUserGroups", (string)null);
                });
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Infrastructure.Identity.ApplicationGroupRole", b =>
                {
                    ...
                    b.HasOne("Offers.CleanArchitecture.Infrastructure.Identity.ApplicationRole", null)
                        .WithMany()
