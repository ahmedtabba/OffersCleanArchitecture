...
namespace Offers.CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20240624094649_add_glossary")]
    partial class add_glossary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.Glossary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.GlossaryLocalization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GlossariesLocalization");
                });
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.OnboardingPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OnboardingPages");
                });

            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.OnboardingPageLocalization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OnboardingPageId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("OnboardingPageLocalizationFieldType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OnboardingPageId");

                    b.ToTable("OnboardingPageLocalization");
                });
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.GlossaryLocalization", b =>
                {
                    b.HasOne("Offers.CleanArchitecture.Domain.Entities.Glossary", null)
                        .WithMany("GlossariesLocalization")
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.OnboardingPageLocalization", b =>
                {
                    ...
                    b.HasOne("Offers.CleanArchitecture.Domain.Entities.OnboardingPage", null)
                        .WithMany()
                        .HasForeignKey("OnboardingPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Offers.CleanArchitecture.Domain.Entities.Glossary", b =>
                {
                    b.Navigation("GlossariesLocalization");
                });
