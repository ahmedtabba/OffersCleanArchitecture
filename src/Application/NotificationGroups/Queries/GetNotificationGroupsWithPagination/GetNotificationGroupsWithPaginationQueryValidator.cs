...
{
    private readonly ILogger<GetNotificationGroupsWithPaginationQueryValidator> _logger;

    public GetNotificationGroupsWithPaginationQueryValidator(ILogger<GetNotificationGroupsWithPaginationQueryValidator> logger)
    {
        _logger = logger;
